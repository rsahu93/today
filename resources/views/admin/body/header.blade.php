    ...
    <ul class="header_menu">
        <li><a href="#" class="search_btn" data-toggle="modal" data-target="#myModal"><i
            ...
            <div class="modal fade search_box" id="myModal">
                <button type="button" class="float-right m-2 text-white close" data-dismiss="modal">&times;</button>
                <form action="#" class="modal-dialog modal-lg">

                    <div class="bg-transparent modal-content">
                        <!-- Modal body -->
                        <div class="modal-body">
                            <input class="text-white bg-transparent form-control form-control-lg" type="text"
                                placeholder="Search...">
            ...
            <div class="user_item dropdown-menu dropdown-menu-right">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <a href="{{ route('admin.logout') }}"><span><i class="fas fa-unlock-alt"></i></span>
                            Logout</a>
                    </li>
                </ul>
            </div>
